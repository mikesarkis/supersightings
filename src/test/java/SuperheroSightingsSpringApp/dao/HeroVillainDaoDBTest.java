...
public class HeroVillainDaoDBTest {
    ...
    public void testaddhero() {
        ...
        assertEquals(hero1,herofromDao);
        
    }
    @Test
    public void test_get_locations()
    {
        HeroVillain hero1 = new HeroVillain();
        hero1.setName("Batman");
        hero1.setSuperpower("Fight like a bat");
        ...
        list1.add(location1);
        List<Location> list2 = daohero.get_all_Loaction(hero1.getId());
        assertEquals(1, list2.size());
        assertTrue(list2.contains(location1));
    }
    @Test
    public void test_get_organization()
    {
        HeroVillain hero1 = new HeroVillain();
        hero1.setName("Batman");
        hero1.setSuperpower("Fight like a bat");
        ...
        List<Organization> list2 = daohero.get_all_Organization(hero1.getId());
        assertEquals(1, list2.size());
        assertTrue(list2.contains(org1));
    }
